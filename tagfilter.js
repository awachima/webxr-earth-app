...
hi: [
  // --- 有名な場所 ---
  [/मशहूर जगह/g, "प्रसिद्ध स्थान"],
  [/प्रसिद्ध स्थल/g, "प्रसिद्ध स्थान"],

  // --- 有名な場所が映っている ---
  [/प्रसिद्ध स्थान दिख रहा है/g, "प्रसिद्ध स्थान दिखाई दे रहा है"],
  [/प्रसिद्ध स्थान दिख रहे हैं/g, "प्रसिद्ध स्थान दिखाई दे रहा है"],
  [/प्रसिद्ध स्थान दिखाए गए हैं。?/g, "प्रसिद्ध स्थान दिखाई दे रहा है"],
  [/प्रसिद्ध स्थानों को दर्शाया गया है/g, "प्रसिद्ध स्थान दिखाई दे रहा है"],

  // --- 有名な物 ---
  [/प्रसिद्ध चीज़ें/g, "प्रसिद्ध वस्तुएँ"],

  // --- 有名人関連 ---
  [/प्रसिद्ध व्यक्ति से संबंधित है/g, "प्रसिद्ध व्यक्ति से संबंधित"],
  [/मशहूर हस्तियों से जुड़ा हुआ/g, "प्रसिद्ध व्यक्ति से संबंधित"],
  [/मशहूर हस्तियों से संबंधित/g, "प्रसिद्ध व्यक्ति से संबंधित"],

  // --- 盛りだくさん ---
  [/^ढेर सारा$/g, "ढेर सारी विविधता"],
  [/^ढेर सारे$/g, "ढेर सारी विविधता"],
  [/ढेर सारी चीज़ें/g, "ढेर सारी विविधता"],
  [/बहुत कुछ है/g, "ढेर सारी विविधता"],
  [/^बहुत कुछ$/g, "ढेर सारी विविधता"],
  [/^भरपूर$/g, "ढेर सारी विविधता"],
  [/भरपूर विविधता/g, "ढेर सारी विविधता"],
  [/विविधता से भरपूर/g, "ढेर सारी विविधता"],
  [/विविधताओं से भरा हुआ/g, "ढेर सारी विविधता"],

  // --- 訳ありの場所 ---
  [/एक मार्मिक स्थान/g, "अनोखी जगह"],
  [/कहानी वाली जगह/g, "अनोखी जगह"],
  [/बदनाम जगह/g, "अनोखी जगह"],

  // --- いいところ ---
  [/सुंदर जगह/g, "अच्छी जगह"],
[/एक अनोखा स्थान/g, "अनोखी जगह"],
[/एक अनोखी जगह/g, "अनोखी जगह"],
...
fa: [
  // --- 盛りだくさん ---
  [/^پر از تنوع$/g, "بسیار متنوع"],
  [/^پر از جاذبه$/g, "بسیار متنوع"],
  [/^پر از جاذبهها$/g, "بسیار متنوع"],
  [/^پر از دیدنی$/g, "بسیار متنوع"],
  [/^پر از دیدنیها$/g, "بسیار متنوع"],
  [/^پر و پیمان$/g, "بسیار متنوع"],
  [/^پربار$/g, "بسیار متنوع"],
  [/^دیدنیهای فراوان$/g, "بسیار متنوع"],

  // --- 有名な場所 ---
  [/^مکانهای مشهور$/g, "مکان مشهور"],
  [/^مکانهای معروف$/g, "مکان مشهور"],
  [/^مکان معروف$/g, "مکان مشهور"],
  [/^جاذبههای معروف$/g, "مکان مشهور"],
  [/^دیدنیهای معروف$/g, "مکان مشهور"],
  [/^مکانهای دیدنی$/g, "مکان مشهور"],
  [/^مشهور$/g, "مکان مشهور"],
  [/^مشهورات$/g, "مکان مشهور"],

  // --- 有名な場所が映っている ---
  [/^مکان مشهور به تصویر کشیده شدهاند$/g, "مکان مشهور نمایش داده شده"],
  [/^مکان مشهور در تصویر$/g, "مکان مشهور نمایش داده شده"],
  [/^مکان مشهور نمایش داده شدهاند$/g, "مکان مشهور نمایش داده شده"],
  [/^مکانهای مشهور به تصویر کشیده شدهاند$/g, "مکان مشهور نمایش داده شده"],
  [/^مکانهای مشهور در تصویر$/g, "مکان مشهور نمایش داده شده"],
  [/^مکانهای مشهور نمایش داده شدهاند$/g, "مکان مشهور نمایش داده شده"],
  [/^مکانهای معروف به تصویر کشیده شدهاند$/g, "مکان مشهور نمایش داده شده"],
  [/^مکانهای معروف دیده میشوند$/g, "مکان مشهور نمایش داده شده"],

  // --- 訳あり ---
  [/^مکانی با داستانی پنهان$/g, "مکان خاص"],
  [/^مکانی با داستانی خاص$/g, "مکان خاص"],
  [/^مکانی با داستانی مرموز$/g, "مکان خاص"],
  [/^مکانی با گذشتهای پرماجرا$/g, "مکان خاص"],

  // --- 有名な催し ---
  [/^رویدادهای معروف$/g, "رویداد مشهور"],

  // --- いいところ ---
  [/^مکان زیبا$/g, "جای عالی"]
]
  };
